...
train_data = t_traits_sy %>%
  left_join(daymet_all, by = "site_year") %>%
...
```{r unnest weather data}
#train_data_unnest = train_data_w %>%
 # unnest(weather) %>%
...
```{r}
#saveRDS(train_data_w, "../data/training/train_data_w.rds")
```
